...
<div class="w-1/2 flex flex-col justify-center items-center min-h-screen">
    <h1 class="font-bold text-xl my-4">Welcome back!!!</h1>
    <c:if test="${error != null}">
        <p style="color: red ">${error}</p>
    </c:if>
    <div class="flex items-center my-2 justify-center">
        <span>Not yet in the family? &nbsp;</span>
    ...
    <form action="login" method="post" class="w-3/5 flex flex-col">
        ...
        <div class="mt-8">
            <button
                    role="button"
                    aria-label="login "
                    class="focus:ring-2 flex items-center justify-center focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-blue-700 border rounded hover:bg-blue-800 duration-1000 hover:animate-ring py-4 w-full disabled:bg-slate-600"
                    type="submit"
            >
                Sign In
            </button>
